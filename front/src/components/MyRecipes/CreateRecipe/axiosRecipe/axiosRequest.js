...
const axiosRequest = {
  ...
  getCategories: async () => {
    ...
    const response = await axios.get(
      "https://apicuisine.herokuapp.com/api/categories"
    );
  ...
  getDifficulty: async () => {
    ...
    const response = await axios.get(
      "https://apicuisine.herokuapp.com/api/difficulty"
    );
  ...
  getAllergies: async () => {
    ...
    const response = await axios.get(
      "https://apicuisine.herokuapp.com/api/allergies"
    );
  ...
  sendRecipe: async (theRecipe) => {
    ...
    const response = await axios.post(
      "https://apicuisine.herokuapp.com/api/user/newrecipe",
      JSON.stringify(data)
    );
    return response;
  },
