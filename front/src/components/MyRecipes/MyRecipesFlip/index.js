...
// style import
import 'src/components/MyRecipes/style.scss';
...
// page with changes
class MyRecipesFlip extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {   
    ...
    return (
      ...
      {data.recipe.slice(0,3).map((data) => (
      ...
      <h4 className="page-header">Mes recettes</h4>
      <div className="page" ref={this.ref}>
      {data.recipe.slice(3,6).map((data) => (
      ...
      <h4 className="page-header">Mes recettes</h4>
      <div className="page" ref={this.ref}>
      {data.recipe.slice(6,9).map((data) => (
      ...
      <h4 className="page-header">Mes recettes</h4>
      <div className="page" ref={this.ref}>
      {data.recipe.slice(9,12).map((data) => (
