...
// page with changes
class ListByFlipDishResponsiv extends React.Component {
  constructor(props) {
    super(props);
...
dish: []
  ...
  componentDidMount() {
    ...
    axios.get('https://apicuisine.herokuapp.com/api/categories/2/recipes')
      .then((response) => {
...
export default ListByFlipDishResponsiv;
