 ...
 * @property {number} part_number - number of parts
 * @property {string} part_type  - unit or per personne
 * @property {boolean} share - public or private (true or false) 
 * @property {number} category_id - the category of the recipe
 * @property {number} user_id - the creator of the recipe
 * @property {string} description - the description of the recipe
 * @property {number} difficulty_id - the difficulty of the recipe
 * @property {string} label-  the ingredients
